...
INSERT INTO `events` (id, description, end_date, image_path, name, purchase_limit, start_date, tickets_per_user, type, hall_id) VALUES (1, 'Ovo je event', '2017-11-30 00:00:00', 'path', 'Koncert', 2, '2019-11-29 00:00:00', 2, 1, 1);

INSERT INTO `event_days` (id, date, description, name, status, event_id) VALUES (1, '2019-11-29 00:00:00', 'dan 1', 'DAY1', 0, 1);
INSERT INTO `event_days` (id, date, description, name, status, event_id) VALUES (2, '2019-11-30 00:00:00', 'dan 2', 'DAY2', 0, 1);
